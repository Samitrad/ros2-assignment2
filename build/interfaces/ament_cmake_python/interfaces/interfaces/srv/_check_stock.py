...
class Metaclass_CheckStock(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from interfaces.srv import _check_stock
...
class CheckStock(metaclass=Metaclass_CheckStock):
    from interfaces.srv._check_stock import CheckStock_Request as Request
    from interfaces.srv._check_stock import CheckStock_Response as Response
