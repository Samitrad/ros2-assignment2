...
#include "interfaces/action/detail/deliver_item__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interfaces::action::DeliverItem_Goal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::action::DeliverItem_Goal & ros_message)
{
  // Member: item_name
  cdr >> ros_message.item_name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces::action::DeliverItem_Goal;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::action::DeliverItem_Goal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interfaces::action::DeliverItem_Goal *>(
    untyped_ros_message);
...
{
  return &interfaces::action::typesupport_fastrtps_cpp::_DeliverItem_Goal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, action, DeliverItem_Goal)() {
  return &interfaces::action::typesupport_fastrtps_cpp::_DeliverItem_Goal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_interfaces
cdr_serialize(
  const interfaces::action::DeliverItem_Result & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::action::DeliverItem_Result & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = interfaces::action::DeliverItem_Result;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::action::DeliverItem_Result *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<interfaces::action::DeliverItem_Result *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &interfaces::action::typesupport_fastrtps_cpp::_DeliverItem_Result__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, action, DeliverItem_Result)() {
  return &interfaces::action::typesupport_fastrtps_cpp::_DeliverItem_Result__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_interfaces
cdr_serialize(
  const interfaces::action::DeliverItem_Feedback & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: status
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::action::DeliverItem_Feedback & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = interfaces::action::DeliverItem_Feedback;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::action::DeliverItem_Feedback *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<interfaces::action::DeliverItem_Feedback *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &interfaces::action::typesupport_fastrtps_cpp::_DeliverItem_Feedback__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, action, DeliverItem_Feedback)() {
  return &interfaces::action::typesupport_fastrtps_cpp::_DeliverItem_Feedback__handle;
}
...
// functions for interfaces::action::DeliverItem_Goal already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_interfaces
cdr_serialize(
  const interfaces::action::DeliverItem_SendGoal_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::action::DeliverItem_SendGoal_Request & ros_message)
{
  // Member: goal_id
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_DeliverItem_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = interfaces::action::DeliverItem_SendGoal_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::action::DeliverItem_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<interfaces::action::DeliverItem_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &interfaces::action::typesupport_fastrtps_cpp::_DeliverItem_SendGoal_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, action, DeliverItem_SendGoal_Request)() {
  return &interfaces::action::typesupport_fastrtps_cpp::_DeliverItem_SendGoal_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_interfaces
cdr_serialize(
  const interfaces::action::DeliverItem_SendGoal_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: accepted
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::action::DeliverItem_SendGoal_Response & ros_message)
{
  // Member: accepted
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = interfaces::action::DeliverItem_SendGoal_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::action::DeliverItem_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<interfaces::action::DeliverItem_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &interfaces::action::typesupport_fastrtps_cpp::_DeliverItem_SendGoal_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, action, DeliverItem_SendGoal_Response)() {
  return &interfaces::action::typesupport_fastrtps_cpp::_DeliverItem_SendGoal_Response__handle;
}
...
{
  return &interfaces::action::typesupport_fastrtps_cpp::_DeliverItem_SendGoal__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, action, DeliverItem_SendGoal)() {
  return &interfaces::action::typesupport_fastrtps_cpp::_DeliverItem_SendGoal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_interfaces
cdr_serialize(
  const interfaces::action::DeliverItem_GetResult_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::action::DeliverItem_GetResult_Request & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = interfaces::action::DeliverItem_GetResult_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::action::DeliverItem_GetResult_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<interfaces::action::DeliverItem_GetResult_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &interfaces::action::typesupport_fastrtps_cpp::_DeliverItem_GetResult_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, action, DeliverItem_GetResult_Request)() {
  return &interfaces::action::typesupport_fastrtps_cpp::_DeliverItem_GetResult_Request__handle;
}
...
// forward declaration of message dependencies and their conversion functions
// functions for interfaces::action::DeliverItem_Result already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_interfaces
cdr_serialize(
  const interfaces::action::DeliverItem_GetResult_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: status
  cdr << ros_message.status;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::action::DeliverItem_GetResult_Response & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_DeliverItem_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = interfaces::action::DeliverItem_GetResult_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::action::DeliverItem_GetResult_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<interfaces::action::DeliverItem_GetResult_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &interfaces::action::typesupport_fastrtps_cpp::_DeliverItem_GetResult_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, action, DeliverItem_GetResult_Response)() {
  return &interfaces::action::typesupport_fastrtps_cpp::_DeliverItem_GetResult_Response__handle;
}
...
{
  return &interfaces::action::typesupport_fastrtps_cpp::_DeliverItem_GetResult__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, action, DeliverItem_GetResult)() {
  return &interfaces::action::typesupport_fastrtps_cpp::_DeliverItem_GetResult__handle;
}
...
// functions for interfaces::action::DeliverItem_Feedback already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_interfaces
cdr_serialize(
  const interfaces::action::DeliverItem_FeedbackMessage & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interfaces::action::DeliverItem_FeedbackMessage & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  // Member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_DeliverItem_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = interfaces::action::DeliverItem_FeedbackMessage;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interfaces::action::DeliverItem_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<interfaces::action::DeliverItem_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &interfaces::action::typesupport_fastrtps_cpp::_DeliverItem_FeedbackMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interfaces, action, DeliverItem_FeedbackMessage)() {
  return &interfaces::action::typesupport_fastrtps_cpp::_DeliverItem_FeedbackMessage__handle;
}
