...
static const _CheckStock_Request_type_support_symbol_names_t _CheckStock_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, srv, CheckStock_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_interfaces, srv, CheckStock_Request)),
  }
};
...
{
  return &::custom_interfaces::srv::rosidl_typesupport_cpp::CheckStock_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, custom_interfaces, srv, CheckStock_Request)() {
  return get_message_type_support_handle<custom_interfaces::srv::CheckStock_Request>();
}
...
static const _CheckStock_Response_type_support_symbol_names_t _CheckStock_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, srv, CheckStock_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_interfaces, srv, CheckStock_Response)),
  }
};
...
{
  return &::custom_interfaces::srv::rosidl_typesupport_cpp::CheckStock_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, custom_interfaces, srv, CheckStock_Response)() {
  return get_message_type_support_handle<custom_interfaces::srv::CheckStock_Response>();
}
...
static const _CheckStock_type_support_symbol_names_t _CheckStock_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, srv, CheckStock)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_interfaces, srv, CheckStock)),
  }
};
...
{
  return &::custom_interfaces::srv::rosidl_typesupport_cpp::CheckStock_service_type_support_handle;
}
