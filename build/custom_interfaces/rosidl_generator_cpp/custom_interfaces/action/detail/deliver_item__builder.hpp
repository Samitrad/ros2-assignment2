...
{
public:
  explicit Init_DeliverItem_Goal_item_name(::custom_interfaces::action::DeliverItem_Goal & msg)
  : msg_(msg)
  {}
  ::custom_interfaces::action::DeliverItem_Goal item_name(::custom_interfaces::action::DeliverItem_Goal::_item_name_type arg)
  {
...
{
public:
  Init_DeliverItem_Goal_quantity()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_DeliverItem_Goal_item_name quantity(::custom_interfaces::action::DeliverItem_Goal::_quantity_type arg)
  {
    msg_.quantity = std::move(arg);
    return Init_DeliverItem_Goal_item_name(msg_);
  }
...
{
  return custom_interfaces::action::builder::Init_DeliverItem_Goal_quantity();
}
...
class Init_DeliverItem_Result_status
{
public:
  Init_DeliverItem_Result_status()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::custom_interfaces::action::DeliverItem_Result status(::custom_interfaces::action::DeliverItem_Result::_status_type arg)
  {
...
{
  return custom_interfaces::action::builder::Init_DeliverItem_Result_status();
}
...
class Init_DeliverItem_Feedback_message
{
public:
  explicit Init_DeliverItem_Feedback_message(::custom_interfaces::action::DeliverItem_Feedback & msg)
  : msg_(msg)
  {}
  ::custom_interfaces::action::DeliverItem_Feedback message(::custom_interfaces::action::DeliverItem_Feedback::_message_type arg)
  {
...
class Init_DeliverItem_Feedback_success
{
public:
  Init_DeliverItem_Feedback_success()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_DeliverItem_Feedback_message success(::custom_interfaces::action::DeliverItem_Feedback::_success_type arg)
  {
    msg_.success = std::move(arg);
    return Init_DeliverItem_Feedback_message(msg_);
  }
...
{
  return custom_interfaces::action::builder::Init_DeliverItem_Feedback_success();
}
