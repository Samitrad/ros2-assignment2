...
class Metaclass_CheckStock(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'custom_interfaces.srv.CheckStock')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from custom_interfaces.srv import _check_stock
...
class CheckStock(metaclass=Metaclass_CheckStock):
    from custom_interfaces.srv._check_stock import CheckStock_Request as Request
    from custom_interfaces.srv._check_stock import CheckStock_Response as Response
