...
#include "custom_interfaces/srv/detail/check_stock__rosidl_typesupport_fastrtps_c.h"
...
using _CheckStock_Request__ros_msg_type = custom_interfaces__srv__CheckStock_Request;
...
size_t get_serialized_size_custom_interfaces__srv__CheckStock_Request(
  const void * untyped_ros_message,
...
static uint32_t _CheckStock_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interfaces__srv__CheckStock_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces
size_t max_serialized_size_custom_interfaces__srv__CheckStock_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_interfaces__srv__CheckStock_Request;
    is_plain =
      (
...
static size_t _CheckStock_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_interfaces__srv__CheckStock_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces, srv, CheckStock_Request)() {
...
using _CheckStock_Response__ros_msg_type = custom_interfaces__srv__CheckStock_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces
size_t get_serialized_size_custom_interfaces__srv__CheckStock_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CheckStock_Response__ros_msg_type * ros_message = static_cast<const _CheckStock_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interfaces__srv__CheckStock_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_interfaces
size_t max_serialized_size_custom_interfaces__srv__CheckStock_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = custom_interfaces__srv__CheckStock_Response;
    is_plain =
      (
...
static size_t _CheckStock_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_interfaces__srv__CheckStock_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces, srv, CheckStock_Response)() {
...
// already included above
// #include "custom_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "custom_interfaces/srv/check_stock.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_interfaces, srv, CheckStock)() {
